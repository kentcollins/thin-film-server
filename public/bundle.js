...
function System(source, layers){
  this.source = source;
  this.layers = layers;
  this.matrix = thinfilm.getSystemTransferMatrix(this);
  this.reflectance = thinfilm.getSystemReflectance(this);
}
...
},{"mathjs":1}],3:[function(require,module,exports){
...
},{"./jquery-2.0.2.min.js":3,"mathjs":1,"thinfilm":2}]},{},[4])
;